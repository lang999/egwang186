...
function 通用列表(){
    ...
    for(var j=0;j<LIMIT;j++){
        ...
        if(预图片.indexOf("/mac:")!=-1){
            ...
            var 图片="https://raw.githubusercontent.com/lang999/egwang186/master/js3.0/kongbai.gif";
        }else{
            var 图片=baseURL+预图片;
...
eval(e2Rex(getHttp('https://raw.githubusercontent.com/lililiwuming/iptv/master/aliyun/QJS.js'),'.dn64()'));
}
